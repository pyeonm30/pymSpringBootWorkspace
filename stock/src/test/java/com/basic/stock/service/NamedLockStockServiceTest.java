...
import com.basic.stock.facade.NamedLockStockFaacade;
...
class NamedLockStockServiceTest {
    ...
    @Autowired
    private NamedLockStockFaacade namedLockStockFaacade;  // 재시도 해주는 로직 객체
    @Autowired
    ...
    public void orderSametime100Stock() throws InterruptedException {
        ...
        for(int i =0; i < treadCount; i++){
            ...
            executorService.submit(()->{
                try{
                    namedLockStockFaacade.decreaseStock(1L,1L);
                }catch (Exception e){
